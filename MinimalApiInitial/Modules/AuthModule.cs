...
namespace MinimalApiInitial.Modules;

public static class AuthModule
{
    public static void RegisterAuthModuleEndpoints(this IEndpointRouteBuilder endpoints)
    {
        endpoints.MapPost("/security/getToken", [AllowAnonymous](IConfiguration configuration, IMemoryCache cache) =>
        {
